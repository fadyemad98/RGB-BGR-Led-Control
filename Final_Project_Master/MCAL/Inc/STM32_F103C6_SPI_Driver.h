...
//@ref SPI_Device_Mode
#define SPI_Device_Mode_SLAVE                  			(0x00000000U) 	// register|= SPI_Device_Mode_SLAVE --> nothing happen (by default bit = 0)
...
#define SPI_DIRECTION_2LINES_RXONLY     				(0x1U<<10) 				  //Bit 10 CR1.RXONLY: Receive only
#define SPI_DIRECTION_1LINE_receive_only          		((0x1U<<15) ) 			  //Bit 15 CR1.BIDIMODE: Bidirectional data mode enable
#define SPI_DIRECTION_1LINE_transmit_only             	((0x1U<<15) | (0x1U<<14)) //Bit 15 CR1.BIDIMODE: Bidirectional data mode enable &
//Bit 14 CR1.BIDIOE: Output enable in bidirectional mode

//@ref SPI_Frame_Format
#define SPI_Frame_Format_MSB_transmitted_first                  (0x00000000U)  	//Bit 7 CR1.LSBFIRST: Frame format
#define SPI_Frame_Format_LSB_transmitted_first                	(0x1U<<7) 		//Bit 7 CR1.LSBFIRST: Frame format

//@ref SPI_DataSize
#define SPI_DataSize_8BIT           						    (0x00000000U)
#define SPI_DataSize_16BIT          						    (0x1U<<11)    //Bit 11  CR1.DFF: Data frame format
...
extern const SPI_Config_t SPICONFIG;
extern const GPIO_PINConfig_t spiNssPin;
