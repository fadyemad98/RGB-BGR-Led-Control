...
#define SYSTICK_STK_CTRL			*(volatile uint32_t *)(SYSTICK_Base + 0x00 )
#define SYSTICK_STK_LOAD			*(volatile uint32_t *)(SYSTICK_Base + 0x04 )
#define SYSTICK_STK_VAL             *(volatile uint32_t *)(SYSTICK_Base + 0x08 )
#define SYSTICK_STK_CALIB           *(volatile uint32_t *)(SYSTICK_Base + 0x0c )
...
//I2C clock RESET
#define RCC_I2C1_Reset()		( RCC->RCC_APB1RSTR |= (1<<21) )
#define RCC_I2C2_Reset()		( RCC->RCC_APB1RSTR |= (1<<22) )

//I2C clock Enable
#define RCC_ADC1_CLK_EN()		( RCC->RCC_APB1ENR  |= (1<<9)  )
#define RCC_ADC2_CLK_EN()		( RCC->RCC_APB1ENR  |= (1<<10) )

//I2C clock RESET
#define RCC_ADC1_Reset()		( RCC->RCC_APB1RSTR |= (1<<9)  )
#define RCC_ADC2_Reset()		( RCC->RCC_APB1RSTR |= (1<<10) )
...
//ADC
#define NVIC_IRQ10_EXTI4_Enable   		(NVIC_ISER0 |= 1<<18)
#define NVIC_IRQ10_EXTI4_Enable   		(NVIC_ISER0 |= 1<<18)

#define NVIC_IRQ10_EXTI4_Disable   		(NVIC_ICER0 |= 1<<18)
#define NVIC_IRQ10_EXTI4_Disable   		(NVIC_ICER0 |= 1<<18)
