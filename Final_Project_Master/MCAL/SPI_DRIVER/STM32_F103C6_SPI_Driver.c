...
SPI_Config_t Global_SPI_Config1 ;		//taking copy of config as if user  takes an object from config struct into function otherwise main
SPI_Config_t Global_SPI_Config2 ;       // its stack will close deleting the config object in stack of this function
